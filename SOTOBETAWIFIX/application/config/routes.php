...
$route['api.html']='api_cons/api/pembayaran';
$route['lihat_detail_pesanan/(:any)']='user_cons/order/lihat_detail_pesanan/$1';
//admin Routes
$route['administrator/login.html']='login';
$route['administrator/dashboard.html']='admin_cons/admin';
$route['administrator/pesanan-masuk']='models/admin_data/getcount_pesanan_masuk';
