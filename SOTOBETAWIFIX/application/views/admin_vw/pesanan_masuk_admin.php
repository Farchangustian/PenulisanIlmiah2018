<!-- Page Content -->
    ...
    <div class="panel panel-default">
        ...
        <?php } else {
           ...
           foreach ($pesanan as $data) {?>
               <tr class="<?php echo $data->id_status_pembayaran==0?'danger':'success';?>">
    ...
    <td class="text-left">
                   <?php //echo $data->status_pesanan==0 ) {
                    If ($data->id_status_pemesanan==0 ) { 
                    echo "belum diporoses";  }
                    else if ($data->id_status_pemesanan==1) {
                    echo "Sedang diproses"; }
                    else if ($data->id_status_pemesanan==2) {
                    echo "Selesai"; }
                    ?></td>
    <td class="text-center">
                   <?php 
                   if ($data->id_status_pembayaran==0) {
                   echo "belum"; }
                   elseif ($data->id_status_pembayaran==1) {
                   echo "Lunas";}
                   elseif ($data->id_status_pemesanan==2) {
                   echo "Selesai";}
                   ?></td>
                   <!--aksi button-->
                   <td class="text-center">
