...
<body onload="window.print()" style="margin-bottom:50px">
	<div class="container bordered">
		<h3>
			<img class="img-responsive" alt="Brand" src="asset/img/gambar.jpg" width="25%"><br> Tagihan Pemesanan
		</h3><br>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body table-responsive">
				<table class="table">
					...
					<tr>
						<td class="middle">Biaya Pengiriman</td>
						<td class="middle">:</td>
						<td class="middle">Rp. <?php echo number_format($hargaMetode) ?>,-</td>
					</tr>
					<tr>
		...
		<div>
			...
			<div style="padding-top:20px;margin-bottom:20px" class="col-sm-12  text-center bg-info">
				<ul class="list-unstyled">
					<li><label>Bank BRI 	: 1403-0100-3185-505  </label></li>
					<li><label>Bank BNI 	: 5264-2207-0161-4095 </label></li>
				</ul>
			</div>
			<p>
				Apabila dalam 3 hari tagihan ini belum dipenuhi maka pemesanan akan dianggap batal.<br><br><br>
				Terimakasih,<br> 
				SOTO BETAWI IBU HJ .TITIAGUS.
			</p>
		</div>
	</div>
</body>
