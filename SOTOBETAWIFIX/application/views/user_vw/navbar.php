	  ...
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="home.html">
	      	<img class="img-responsive" alt="Brand" src="asset/img/logosoto.jpg" width="140px">
	      </a>
	    </div>
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav navbar-right">
	      	<li class="active"><a id="nav-menu" href="lihat-menu.html">Menu Soto</a></li>
	        		 ...
	        		 <li>
			        	<div style="padding-left:10px;padding-right:10px" class="navbar-btn">
			      			<a href="edit_profile.html">
			      				<img style="border:1px solid #D3D3D3;width:32px;height:32px" class="img-circle" src="<?php echo $this->session->userdata('profile_picture');?>">
			      			</a>
			        	</div>
			        </li>
	        		<li>
